...
- Updated to tinted-builder `0.15.0` lib
...
- Updated to tinted-builder `0.13.0` lib

## [0.16.0] - 2026-04-19

### Changed

- Updated to tinted-builder `0.12.0` lib
...
- Fix `scheme.system` and `scheme.slug` support in `templates/config.yaml` file

## [0.15.1] - 2026-04-19

### Fixed

- Have default `--ignore`s set to `**/*.md`, `**/.*` and `**/LICENSE` but is
  overwridden when the user uses `--ignore`
...
[0.20.1]: https://github.com/tinted-theming/tinted-builder-rust/compare/v0.20.0...v0.20.1
[0.20.0]: https://github.com/tinted-theming/tinted-builder-rust/compare/v0.19.0...v0.20.0
[0.19.0]: https://github.com/tinted-theming/tinted-builder-rust/compare/v0.18.0...v0.19.0
[0.18.0]: https://github.com/tinted-theming/tinted-builder-rust/compare/v0.17.0...v0.18.0
[0.17.0]: https://github.com/tinted-theming/tinted-builder-rust/compare/v0.16.0...v0.17.0
[0.16.0]: https://github.com/tinted-theming/tinted-builder-rust/compare/v0.15.3...v0.16.0
[0.15.3]: https://github.com/tinted-theming/tinted-builder-rust/compare/v0.15.2...v0.15.3
[0.15.2]: https://github.com/tinted-theming/tinted-builder-rust/compare/v0.15.1...v0.15.2
[0.15.1]: https://github.com/tinted-theming/tinted-builder-rust/compare/v0.15.0...v0.15.1
